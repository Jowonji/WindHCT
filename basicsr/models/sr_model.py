...
class SRModel(BaseModel):
    ...
    def test_selfensemble(self):
        """Self-ensemble test: average predictions over 8 flip/transpose augmentations."""
        # TODO: to be tested
        ...
        # invert the augmentations on each output
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        if 'hr_min' in stats:
            ...
            raise KeyError("norm_path npz file must contain hr_min/hr_max or min_hr/max_hr.")
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            # convert model output and GT to numpy
            ...
            # force (H, W) shape if extra dims remain
            if sr_tensor.ndim != 2:
            ...
            # denormalize back to physical wind-speed range
            sr_img_rescaled = sr_tensor * (hr_max - hr_min) + hr_min
            gt_img_rescaled = gt_tensor * (hr_max - hr_min) + hr_min

            # restrict evaluation to the valid mask region, if provided
            if 'mask' in val_data:
            ...
            if save_img and sr_img_rescaled.ndim == 2:
                ...
                # visualize the masked region only (mask == 1: valid area)
